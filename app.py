...
def set_background(image_file):
    try:
        ruta = os.path.join(os.path.dirname(__file__), image_file)
...
claves_totales = {
    ...
    "hybrid_mode": {
        "Español": "_**Híbrido**_: Mezcla de azar y lógica estadística optimizado con IA.",
        "English": "_**Hybrid**_: AI-optimized mix of randomness and statistical logic.",
        "Français": "_**Hybride**_: Mélange optimisé par IA d'aléatoire et de logique statistique.",
        "Italiano": "_**Ibrido**_: Miscela ottimizzata con IA di casualità e logica statistica.",
        "Deutsch": "_**Hybrid**_: KI-optimierte Mischung aus Zufall und statistischer Logik.",
        "Português": "_**Híbrido**_: Mistura otimizada por IA de aleatoriedade e lógica estatística.",
        "Nederlands": "_**Hybride**_: Met AI geoptimaliseerde mix van willekeur en statistische logica."
     },
    "mode_label": {
...
# Reconstrucción mejorada del diccionario de traducciones
